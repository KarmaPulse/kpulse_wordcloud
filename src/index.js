...
class WordCloud extends React.Component<TProps, TState> {
  ...
  _update(props: TProps): void {
    ...
    this._vis.attr(
      'transform',
      `translate(${this._width / 2}, ${this._height / 2})scale(1.0020877122879028,1.0020877122879028)`,
    ...
    this.fontSizeNew = value => {
      const initialValues = {
        MAX: _.maxBy(words, 'total'),
        MIN: _.minBy(words, 'total'),
        FONT_MAX: 40,
        FONT_MIN: 12,
      };
    ...
    this._layout
      ...
      .text(this._setText)
      .font(fontFamily)
      .fontSize((d: Object): number => this.fontSizeNew(d[wordCountKey]))
      .spiral(spiral)
